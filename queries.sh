...
echo $($PSQL "SELECT DISTINCT(name) FROM teams t LEFT JOIN games g ON t.team_id=g.winner_id OR t.team_id=g.opponent_id WHERE year=2014 AND round='Eighth-Final' ORDER BY name")
